      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h1 className="h2 mb-4">Один продукт, неограниченное количество решений</h1>
            <p className="text-xl text-gray-400">Мы помогаем обеспечить ваш бизнес всем необходимым.</p>
          </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Держите проекты в соответствии с графиком</h3>
                  <p className="text-xl text-gray-400 mb-4">Мы помогаем обеспечить ваш бизнес всем необходимым.</p>
