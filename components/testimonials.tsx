      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Не верьте нам на слово</h2>
            <p className="text-xl text-gray-400">Поверьте нашим клиентам.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">— Open PRO позволяет мне быстро получать важную информацию, чтобы я мог сосредоточиться на своей продуктивной работе. У меня есть Open PRO уже около 24 часов, и я, честно говоря, не знаю, как я работал без него раньше.</blockquote>
